...
import { router as WarehouseRoutes } from "../routes/warehouse.routes";
import { router as InventoryRoutes } from "../routes/inventory.routes";
...
export class Server {
  ...
  routes() {
    ...
    this.app.use(this.paths.warehouses, WarehouseRoutes);
    this.app.use(this.paths.inventory, InventoryRoutes);
  }
